...
export function Comment({ root, comment, depth = 0, maxDepth = 3, limit, showOnlyOwn }: CommentProps) {
  ...
  const replies = showOnlyOwn
    ? allReplies.filter((r) => r.pubkey === user?.pubkey)
    : allReplies;
